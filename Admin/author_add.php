                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="authorname" class="form-control" placeholder="Enter Your Category">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Date Of Birth</label>
                                                <input type="date" name="dob" placeholder="Select Your Date Of Birth" class="form-control" >
                                            </div>
                                            <div class="form-group col-md-12">
