...
if (isset($_POST['update'])) {
    ...
    $sql = "update books set BookName='bookname',Description='description',Price='price',CatId_FK='catId',AuthId_FK,BookImage) values ('$bookname','$description','$price','$catId','$authId','$Image')";
    $result = mysqli_query($conn, $sql);
