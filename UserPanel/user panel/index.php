...
?>
					...
					<div id="main">
						...
						<div class="inner">
							...
							<p class="text-center"><a href="alcategory.php">More Books &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
							...
							<p class="text-center"><a href="alauthor.php">More Books &nbsp;<i class="fa fa-long-arrow-right"></i></a></p>
